...
public interface IReviewRepository : IGenericRepository<Review>
{
    ...
    /// </summary>
    Task<(List<Review> Reviews, int TotalCount)> GetReviewsByVenueIdAsync(int venueId, int page, int pageSize, int? currentMemberId = null, int? currentCoupleId = null, int? partnerMemberId = null);
    ...
    Task<bool> HasMemberReviewedVenueAsync(int memberId, int venueId, int? coupleProfileId);
